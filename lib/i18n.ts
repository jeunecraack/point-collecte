...
export const T = {
  ar: {
    ...
    encartSignaler: "يتصل متطوع بالشخص المذكور أدناه ليتأكد من العنوان، ثم تُضاف البطاقة.",
  ...
  fr: {
    ...
    encartSignaler: "Un bénévole rappelle la personne indiquée ci-dessous pour confirmer l'adresse, puis la fiche est ajoutée.",
